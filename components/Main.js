        ...
        return (
            <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
                ...
                <article id="work"
                    ...
                    <span className="image main"><img src={`${process.env.BACKEND_URL}/static/images/pic02.jpg`}
                                                      alt=""/></span>
                ...
                <article id="about"
                    ...
                    <span className="image main"><img src={`${process.env.BACKEND_URL}/static/images/pic03.jpg`}
                                                      alt=""/></span>
